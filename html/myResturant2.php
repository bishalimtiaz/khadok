...
<body id="myFrame">
	...
	<div class="parallax">
		...
		<!-- onmouseenter="dropenter(this)" onmouseout="dropOut(this)" -->
		...
		<form class="addForm" name="addResturantForm" enctype="multipart/form-data">
			...
			<fieldset class="firstField" id="ff">
					...
					<div id="ff5"><input type="text" name="contact" placeholder="Phone No"></div>
			...
			<fieldset id="sf" class="secondfield">
					...
					<div id="sflogo">
						<img id="rimg" src="../images/resturant/tastyigniter-logo.png">
					</div>
					...
					if (mysqli_num_rows($select_query_run) > 0){
						...
						while($row = mysqli_fetch_assoc($select_query_run)){
							...
							<div class="foodItem" onmouseover="rateenter(this)" onmouseout="rateout(this)">
								...
								<?php 
									if (isset($_COOKIE["goo"])) {
										# code...
								?>
								<img onmouseenter="mouseenter(this)" onmouseout="mouseOut(this)" src="../images/food/<?php echo $fimg; ?>" id="fmg">
								<i class="fa fa-heart" id="hrt" onmouseenter="mouseenterInfo(this)" onmouseout="mouseOutInfo(this)" onclick="fav()" style="display: none;font-size: 4vw;"></i>
								<?php } ?>
		...
		function fav(){
			...
			xhttp.onreadystatechange = function() {
	   				 if (this.readyState == 4 && this.status == 200) {
	      				...
	      				/*if (txt.trim()=="You Already Added This Food To Your Favourite List") {
	      					alert(txt.trim());
	      				}
	      				else if (txt.trim()="This Food Is Added To Your Favourite List"){
	      					alert(txt.trim());
